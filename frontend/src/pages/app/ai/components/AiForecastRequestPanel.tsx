...
export function AiForecastRequestPanel({ disabled, onGenerate }: Props) {
  ...
  return (
    <div className="rounded-xl border border-border bg-surface-raised p-4">
      <h2 className="mb-3 text-sm font-semibold text-text-primary">Forecast Request</h2>
      <div className="space-y-2">
        ...
        <button
          ...
          onClick={() => void submit()}
          disabled={disabled}
          className="w-full rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:bg-surface-subtle"
        >
          Generate Forecast
        </button>
