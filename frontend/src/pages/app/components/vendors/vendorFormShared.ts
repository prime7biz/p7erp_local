...
export function vendorCreateToAiFieldCurrent(c: VendorCreate): Record<string, string> {
  return vendorSnapshotToAiFieldCurrent({
    ...
    city: c.city,
    stateOrRegion: c.state_or_region,
    ...
    shippingTerms: c.shipping_terms,
    leadTimeNotes: c.lead_time_notes,
    ...
    complianceReferenceNumbers: c.compliance_reference_numbers,
    certificationsSummary: c.certifications_summary,
