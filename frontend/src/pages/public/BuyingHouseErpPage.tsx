...
export function BuyingHouseErpPage() {
      ...
      <section className="relative py-16 lg:py-24 bg-gray-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl max-w-5xl mx-auto">
            <img src="/images/buying-house-global.png" alt="Global Buying House Operations Diagram" width={1200} height={800} className="w-full h-auto" loading="lazy" />
