...
import { MapPin, Mail, Phone, MessageCircle, Clock, Send, Loader2, Building2, ArrowRight } from "lucide-react";
...
const contactInfo = [
  ...
  { icon: Mail, label: "Email", value: "info@prime7erp.com", href: "mailto:info@prime7erp.com" },
