...
const processSteps = [
  { label: "Buyer Inquiry", color: "bg-primary" },
  { label: "Costing", color: "bg-primary/90" },
  { label: "Sample Dev", color: "bg-primary/80" },
  { label: "Order Confirm", color: "bg-primary/70" },
  { label: "Sourcing", color: "bg-primary/60" },
  { label: "Production", color: "bg-primary/50" },
  { label: "QC & Inspection", color: "bg-primary/40" },
  { label: "Shipment", color: "bg-primary/30" },
  { label: "LC Realization", color: "bg-primary/30" },
];
...
const faqs = [
  {
    ...
    a: "Generic ERPs lack garment-specific features like style management, BOM with size-color matrices, consumption tracking, TNA planning, and LC management. A garment-specific ERP like Prime7 ERP handles these natively.",
  },
  {
    q: "How does Prime7 ERP handle style and BOM management?",
    a: "Prime7 ERP uses styles as master entities with components, colorways, and size scales. BOMs are linked to styles with automatic consumption calculation across size-color breakdowns.",
  },
  {
    q: "Can Prime7 ERP track production across cutting, sewing, and finishing?",
    a: "Yes. Prime7 ERP provides real-time WIP tracking across all production stages — cutting, sewing, finishing, and packing — with line-level visibility and efficiency metrics.",
  },
  {
    q: "Does Prime7 ERP integrate with buyer portals?",
    a: "Prime7 ERP can export data in formats compatible with major buyer portals and supports standard EDI integrations for order and shipment data exchange.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {differentiators.map((diff) => (
              <div key={diff.title} className="bg-white rounded-xl p-6 shadow-sm border border-primary/20 hover:shadow-md hover:border-primary/30 transition-all">
