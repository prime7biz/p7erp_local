    ...
    <>
      <section className="py-16 lg:py-24 bg-surface-raised">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link to="/" className="text-sm text-brand-primary hover:underline mb-6 inline-block">← Back to Home</Link>
          <div className="mb-12">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <div>
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-2">Business Data</h3>
              <ul className="list-disc pl-6 text-text-secondary space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-2">Automatically Collected Information</h3>
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">3. Data Storage</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">4. Cookies</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">5. Third-Party Services</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div>
              ...
              <div className="mt-4 bg-surface-subtle rounded-lg p-6 border border-border">
                <p className="text-text-secondary font-medium">Prime7 ERP</p>
                <p className="text-text-secondary">Gulshan-2, Dhaka 1212, Bangladesh</p>
                <p className="text-text-secondary">Email: <a href="mailto:privacy@prime7erp.com" className="text-brand-primary hover:underline">privacy@prime7erp.com</a></p>
                <p className="text-text-secondary">Or via our <Link to="/contact" className="text-brand-primary hover:underline">Contact</Link> page.</p>
              </div>
            </div>
          </div>
        </div>
