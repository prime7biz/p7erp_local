      ...
      <section className="py-16 lg:py-24 bg-surface-raised">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">2. Account Terms</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">3. Service Description</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">4. Fees &amp; Payment</h2>
              <p className="text-text-secondary leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">5. Data Ownership</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="mt-8 bg-surface-subtle rounded-lg p-6 border border-border">
              <p className="text-text-secondary font-medium">Questions about these Terms?</p>
              <p className="text-text-secondary mt-1">Contact us at <a href="mailto:legal@prime7erp.com" className="text-brand-primary hover:underline">legal@prime7erp.com</a> or via our <Link to="/contact" className="text-brand-primary hover:underline">Contact</Link> page.</p>
