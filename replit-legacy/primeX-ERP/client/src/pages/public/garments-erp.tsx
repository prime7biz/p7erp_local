...
const painPoints = [
  ...
  },
  {
    ...
    solution: "BOM-based consumption matrix with real-time tracking against standards per size and color. Learn more about consumption control.",
    resourceLink: "/resources/consumption-control-garments",
...
const faqs = [
  {
    ...
    a: "Generic ERPs lack garment-specific features like style management, BOM with size-color matrices, consumption tracking, TNA planning, and LC management. A garment-specific ERP like Prime7 handles these natively.",
  },
  {
    q: "How does Prime7 handle style and BOM management?",
    a: "Prime7 uses styles as master entities with components, colorways, and size scales. BOMs are linked to styles with automatic consumption calculation across size-color breakdowns.",
  },
  {
    q: "Can Prime7 track production across cutting, sewing, and finishing?",
    a: "Yes. Prime7 provides real-time WIP tracking across all production stages — cutting, sewing, finishing, and packing — with line-level visibility and efficiency metrics.",
  },
  {
    q: "Does Prime7 integrate with buyer portals?",
    a: "Prime7 can export data in formats compatible with major buyer portals and supports standard EDI integrations for order and shipment data exchange.",
  },
];
...
export default function GarmentsErpPage() {
  ...
  return (
    <PublicLayout>
      <SEOHead
        title="Garments ERP Solution | End-to-End Manufacturing | Prime7"
        description="Purpose-built ERP for garment manufacturers. Manage styles, production, inventory & exports in one platform. Trusted worldwide. Free 14-day trial."
        canonical="https://prime7erp.com/garments-erp"
        keywords="garments ERP Bangladesh, RMG ERP software, garment manufacturing ERP, buying house software Bangladesh, clothing industry ERP, textile ERP system"
        jsonLd={faqJsonLd}
        breadcrumbs={[{name: "Home", url: "https://prime7erp.com/"}, {name: "Garments ERP", url: "https://prime7erp.com/garments-erp"}]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-1.5 rounded-full text-sm font-medium mb-6">
              ...
              Purpose-Built for Bangladesh RMG
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              The Only ERP Built Specifically for
              <br />
              <span className="text-primary">Bangladesh RMG Industry</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              If any of these sound familiar, you're not alone — and Prime7 was built to solve each one.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              How Prime7 Solves Each Challenge
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Prime7 covers every step from the first buyer inquiry to final LC realization.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-primary/5 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Generic ERPs force garment manufacturers to adapt their processes. Prime7 adapts to you.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Bangladesh RMG at a Glance
            </h2>
            <p className="text-lg text-blue-100 max-w-2xl mx-auto">
              The garment industry is the backbone of Bangladesh's economy. It's time to digitize.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">$40B+</div>
              <p className="text-blue-200">Annual RMG Exports</p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">4,000+</div>
              <p className="text-blue-200">Active Factories</p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">4M+</div>
              <p className="text-blue-200">Workers Employed</p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">&lt;10%</div>
              <p className="text-blue-200">Factories Digitized</p>
            </div>
          </div>
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-6 py-3">
              <TrendingUp className="w-5 h-5" />
              <span className="text-sm font-medium">The opportunity: 90%+ of factories still run on Excel and manual processes</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-500 mb-4">Related Resources</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/features"><span className="inline-block px-4 py-2 bg-primary/5 text-primary text-sm font-medium rounded-full hover:bg-primary/10 transition-colors cursor-pointer">Explore All Features →</span></Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Common questions from garment manufacturers considering Prime7 ERP.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-primary/20 text-blue-300 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
            ...
            Join 100+ Garment Factories
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Join the Digital Transformation
          </h2>
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            The future of Bangladesh's garment industry is digital. Don't let your factory fall behind.
            Start your journey with Prime7 ERP today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/app/register">
              <Button size="lg" className="gap-2 text-base px-8">
